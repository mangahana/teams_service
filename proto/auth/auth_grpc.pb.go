...
const (
	User_GetSession_FullMethodName = "/user_proto.User/GetSession"
)
...
type UserClient interface {
	GetSession(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *userClient) GetSession(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (UnimplementedUserServer) GetSession(context.Context, *Request) (*Response, error) {
...
func _User_GetSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetSession(ctx, req.(*Request))
	}
